...
<head>
  ...
  <title>Bed Availability - MediBook</title>
...
<body class="min-h-screen bg-gray-50">
  ...
  <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
    <h2 class="text-2xl font-bold text-gray-900 mb-6">Bed Availability</h2>
    <?php if (empty($beds)): ?>
      <p class="text-gray-600">No beds found.</p>
    <?php else: ?>
        ...
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <?php foreach ($beds as $bed): ?>
              <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo htmlspecialchars($bed['id']); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo htmlspecialchars($bed['ward']); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo htmlspecialchars($bed['hospital_name']); ?></td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo htmlspecialchars($bed['status']); ?></td>
              </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
